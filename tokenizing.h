...
enum TokenType {
   ...
   Left, Right, If, Else, Return, Struct, Array, ArraySet, ArrayAccess,
   StructDef, StructType, StructBuild, StructElemSet, StructIndirElemSet, 
   StructElemAccess, StructIndirElemAccess, Element,
...
const unordered_map<TokenType, string> TokenName = {
   ...
   {StructDef, "StructDef"},
   {StructBuild, "StructBuild"},
   {StructElemSet, "StructElemSet"},
   {StructIndirElemSet, "StructIndirectElemSet"},
   {StructElemAccess, "StructElemAccess"},
   {StructIndirElemAccess, "StructIndirectElemAccess"},
...
const vector<pair<TokenType, regex>> TokenRegex = {
   ...
   {StructDef, regex("^sdef")},
   {StructBuild, regex("^structbuild")},
   {StructElemSet, regex("^structelemset")},
   {StructIndirElemSet, regex("^structindirelemset")},
   {StructElemAccess, regex("^structelemaccess")},
   {StructIndirElemAccess, regex("^structindirelemaccess")},
   {StructType, regex("^structtype")},
   {ArraySet, regex("^arrayset")},
